...
type TSelectorReturn<P extends TSelector<any>> =
  P extends TSelector<any, infer S> ? S : never;

export function createContextHook<PA, RT>(useExternalStore: (props: PA) => RT) {
  ...
  return {
    ...
    withSelector<C extends ComponentType<any>, S extends TSelector<RT>>(
      ...
      return function FinalComponent(
        props: ComponentProps<C> & Partial<TSelectorReturn<S>>,
      ) {
    ...
    withStore<P>(
      ...
      modelProps: PA | ((props: P) => PA) = (props) => props as any,
    ) {
      return function FinalComponent(props: P) {
        return (
          <Provider
            modelProps={
              typeof modelProps === 'function'
                ? (modelProps as any)(props)
                : modelProps
            }
          >
